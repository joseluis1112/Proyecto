      ...
      <nav class="navbar navbar-expand-lg navbar-dark fixed-top shadow">
        <div class="container-fluid">
          <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
            <ul class="navbar-nav">
              <li class="nav-item">
                <router-link to="/inicio-cliente" class="nav-link px-3">Inicio</router-link>
              </li>
              <li class="nav-item">
                <router-link to="/ver-rutas-cliente" class="nav-link px-3">Ver Rutas</router-link>
              </li>
              <li class="nav-item">
                <router-link to="/mis-reservas" class="nav-link px-3">Mis Reservas</router-link>
              </li>
              <li class="nav-item">
                <router-link to="/mis-rutas" class="nav-link px-3">Mis Rutas</router-link>
              </li>
            </ul>
