      ...
      <nav class="navbar navbar-expand-lg navbar-dark fixed-top shadow">
        <div class="container-fluid">
          <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
            <ul class="navbar-nav">
              <li class="nav-item">
                <router-link to="/inicio-guia" class="nav-link px-3">Inicio</router-link>
              </li>
              <li class="nav-item">
                <router-link to="/ver-rutas" class="nav-link px-3">Rutas Asignadas</router-link>
              </li>
              <li class="nav-item">
                <router-link to="/pasar-lista" class="nav-link px-3">Pasar Lista</router-link>
              </li>
            </ul>
